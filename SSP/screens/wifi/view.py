...
from PyQt5.QtWidgets import (
    ...
    QLineEdit, QStackedLayout, QSizePolicy
)
...
class WifiScreenView(QWidget):
    ...
    def setup_ui(self):
        ...
        guide_text = QLabel(
            ...
            '2. Scan the provided QR code or input the provided OTP to proceed to the printing configuration.<br><br>'
        )
        ...
        cancel_title.setStyleSheet("color: #36454F; font-size: 22px; font-weight: bold; background: transparent; border: none;")
        cancel_desc = QLabel(
            'Scan QR code to access files. '
        )
        cancel_desc.setAlignment(Qt.AlignCenter)
        cancel_desc.setWordWrap(True)
        cancel_desc.setStyleSheet("color: #36454F; font-size: 13px; background: transparent; border: none;")
